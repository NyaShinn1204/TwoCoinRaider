...
def load_lol():
    ...
    checkbox01 = ctk.CTkCheckBox(frame_scroll, text="CTkCheckBox01", command=checkbox_event01,variable=check_var01, onvalue="on", offvalue="off")
    ...
    checkbox02= ctk.CTkCheckBox(frame_scroll, text="CTkCheckBox02", command=checkbox_event02,variable=check_var02, onvalue="on", offvalue="off")
    checkbox02.place(x=checkbox01_x,y=checkbox01_y+40)
    app.update()
