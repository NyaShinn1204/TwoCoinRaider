...
def module_thread(num):
  ...
  if num == 1_3_2:
    threading.Thread(target=module_vc_join.stop).start()
...
def module_scroll_frame(num1, num2):
  ...
  if num1 == 1:
    if num2 == 1:
      ...
      ctk.CTkButton(modules_frame01_03, text="Start", fg_color=c2, hover_color=c5, border_width=1, border_color=c3, width=60, height=25, command=lambda: module_thread(1_3_1)).place(x=5,y=127)
      ctk.CTkButton(modules_frame01_03, text="Stop", fg_color=c2, hover_color=c5, border_width=1, border_color=c3, width=60, height=25, command=lambda: module_thread(1_3_2)).place(x=70,y=127)
