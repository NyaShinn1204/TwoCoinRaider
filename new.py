...
def module_scroll_frame(num1, num2):
  ...
  if num1 == 1:
    ...
    if num2 == 2:
      ...
      ctk.CTkButton(modules_frame02_03, text="Clear        ", fg_color=c2, hover_color=c5, width=75, height=25, command=lambda: Setting.ticket_serverid.set("")).place(x=5,y=28)
      ctk.CTkEntry(modules_frame02_03, bg_color=c1, fg_color=c4, border_color=c4, text_color="#fff", width=150, height=20, textvariable=Setting.ticket_serverid).place(x=85,y=28)
      tk.Label(modules_frame02_03, bg=c1, fg="#fff", text="Server ID", font=("Roboto", 12)).place(x=240,y=26)
      ctk.CTkButton(modules_frame02_03, text="Clear        ", fg_color=c2, hover_color=c5, width=75, height=25, command=lambda: Setting.ticket_channelid.set("")).place(x=5,y=57)
      ctk.CTkEntry(modules_frame02_03, bg_color=c1, fg_color=c4, border_color=c4, text_color="#fff", width=150, height=20, textvariable=Setting.ticket_channelid).place(x=85,y=57)
      tk.Label(modules_frame02_03, bg=c1, fg="#fff", text="Channel ID", font=("Roboto", 12)).place(x=240,y=55)
      ctk.CTkButton(modules_frame02_03, text="Clear        ", fg_color=c2, hover_color=c5, width=75, height=25, command=lambda: Setting.ticket_messageid.set("")).place(x=5,y=86)
